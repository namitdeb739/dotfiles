---
name: python-pro
description: "Use for building type-safe, production-ready Python: web APIs, CLI tools, automation, and data work requiring async patterns and type coverage."
...
- PEP 8 compliance with ruff format
...
- `uv add` / `uv sync` / `uv run` — never `pip install` in a uv project
- Requirements pinning with uv.lock
...
- Code smell detection with ruff check

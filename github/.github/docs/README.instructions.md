...
| [../instructions/github-operations.instructions.md](../instructions/github-operations.instructions.md)                                           | Operational policy for PR/issue/branch lifecycle commands     | Standardizes safe defaults, confirmation gates, and markdown body handling for GitHub operations.   |

...
| [../prompts/commit-push.prompt.md](../prompts/commit-push.prompt.md) | `swe-subagent` | Present grouping options, then proceed autonomously to split commits, generate standards-compliant messages, and push. |
